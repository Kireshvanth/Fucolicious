                        ...
                        child: Column(
                          children: [
                            ...
                            Expanded(
                              ...
                              child: Container(
                                padding:
                                EdgeInsets.only(left: screenWidth * 0.45),
                                                ...
                                                onPressed: () async {
                                                  if (_locationData != null) {
                                                    ...
                                                    await Fluttertoast
                                                        .showToast(
                                                      msg:
                                                      "Turn on your location to place your order",
                                                      textColor:
                                                      Color(0xffF8AD2C),
                                                      backgroundColor:
                                                      Colors.white,
                  ...
                  Expanded(
                    ...
                    child: Center(
                      child: SmoothPageIndicator(
                        ...
                        effect: WormEffect(
                          // activeStrokeWidth: 0,
                          activeDotColor: Color(0xff4A3500),
                          strokeWidth: 0.5,
                          dotHeight: 7,
                          dotWidth: 7,
                          // fixedCenter: true,
                          dotColor: Color(0xffFFD685),
                        ),
                      ),
                    ),
                  ),
