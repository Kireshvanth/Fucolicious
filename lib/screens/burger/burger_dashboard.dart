              ...
              child: Column(
                children: [
                  Expanded(
                    ...
                    child: Center(
                      child: Image.asset(
                          'assests/burger/burger_dashboard/McDonald_Burger_Logo/McDonald_Burger_Logo.png'),
                    ),
                  ),
                  Expanded(
                    flex: 80,
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => BurgerCustomisation()));
                      },
                      child: Hero(
                        tag: 'burger',
                        child: Container(
                          child: ListWheelScrollViewX(
                            ...
                            children: [
                              UsableCard(
                                image: Image.asset(
                                    'assests/burger/burger_dashboard/rodeo_burger/rodeo_burger.png'),
                                cost: '\$10',
                              ...
                              UsableCard(
                                image: Image.asset(
                                    'assests/burger/burger_dashboard/whooper/whooper.png'),
                                cost: '\$10',
                                itemName: 'Whooper',
                                mustTry: true,
                              ),
                  ...
                  Expanded(
                    child: Center(
                      child: GestureDetector(
                        ...
                        child: Image.asset(
                            'assests/burger/burger_dashboard/Button_Home/button-home.png'),
                      ),
                    ),
                    flex: 8,
                  ),
            ...
            child: Stack(
              children: [
                ...
                mustTry == true
                  ...
                  child: Image.asset(
                      'assests/burger/burger_dashboard/must_try/must_try_image.png'),
                )
                    : Container(
                  color: Colors.transparent,
                ),
            ...
            child: Center(
              child: Container(
                ...
                child: FittedBox(
                  fit: BoxFit.fitWidth,
                  child: Image.asset(
                      'assests/burger/burger_dashboard/Underline_Path/Underline_Path.png'),
                ),
              ),
            ),
          ),
