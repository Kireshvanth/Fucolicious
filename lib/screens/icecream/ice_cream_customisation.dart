                ...
                Container(
                  ...
                  child: Stack(
                    children: [
                      ...
                      Center(
                        child: Image.asset('assests/ice_cream/ice_cream_bg/Icecream_BG_Image.png'),
                      ),
                    ],
                  ),
                ),
                      ...
                      children: [
                            ...
                            children: [
                              ...
                              Column(
                                children: [
                                  ...
                                  Image.asset('assests/ice_cream/underline_path/Underline_Path.png'),
                                ],
                              ),
                            ],
                          ),
                          ...
                          child: ListView(
                            ...
                            children: [
                              VariationsCard(
                                ...
                                subText: 'Regular',
                                imageChildren: [
                                  Image.asset('assests/ice_cream/ice_cream_logo/ice_cream_logo.png'),
                                ],
                              ),
                              VariationsCard(
                                onTap : (){
                                ...
                                borderColor: selectedVariation == 'With Blended Oreo'
                                    ? Color(0xffFCAE13)
                                    : Color(0xffF2F2F2),
                                containerColor: selectedVariation == 'With Blended Oreo'
                                    ? Color(0xffFFF9ED)
                                    : Color(0xffFCFCFC),
                                mainText: 'Matcha',
                                ...
                                imageChildren: [
                                  ...
                                  Image.asset('assests/ice_cream/cookies_logo/cookies_logo.png'),
                              ...
                              VariationsCard(
                                ...
                                borderColor: selectedVariation == 'With Walnuts'
                                    ? Color(0xffFCAE13)
                                    : Color(0xffF2F2F2),
                                containerColor: selectedVariation == 'With Walnuts'
                                    ? Color(0xffFFF9ED)
                                    : Color(0xffFCFCFC),
                                mainText: 'Matcha',
                                ...
                                imageChildren: [
                                  ...
                                  Image.asset('assests/ice_cream/walnut_logo/walnut_logo.png'),
                            ...
                            children: [
                              ServingCard(
                                ...
                                borderColor: selectedServingType == 'Cone'
                                    ...
                                    : Colors.transparent,
                                iceText: 'Cone',
                                backgroundImage: Image.asset('assests/ice_cream/cone/Cone_Image.png'),
                              ),
                              ServingCard(
                                onTap: (){
                                  setState(() {
                                ...
                                borderColor: selectedServingType == 'Cup'
                                    ...
                                    : Colors.transparent,
                                iceText: 'Cup',
                                backgroundImage: Image.asset('assests/ice_cream/cup/Cup_Image.png'),
                              ),
                              ServingCard(
                                onTap: (){
                                  setState(() {
                                ...
                                borderColor: selectedServingType == 'Bar'
                                    ...
                                    : Colors.transparent,
                                iceText: 'Bar',
                                backgroundImage: Image.asset('assests/ice_cream/bar/Bar_Image.png'),
                              ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            ToppingsCard(
                              activate: selectedServingType=='Bar' ? false : true,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            ToppingsCard(
                              activate: selectedServingType=='Cone' ? false : true,
                              toppingName: 'Gems',
                              value: _checkedGems,
                              onChanged: (bool value){
                                setState(() {
                        ...
                        Row(
                          ...
                          children: [
                            ToppingsCard(
                              activate: selectedServingType=='Bar'||selectedServingType=='Cone' ? false : true,
                        ...
                        GestureDetector(
                          onTap: (){
                            ...
                            print('Selected Serving Type : $selectedServingType') ;
                  ...
                  Expanded(
                    child: Center(
                      child: GestureDetector(
                        ...
                        child: Image.asset('assests/ice_cream/button_home/button_home.png'),
                      ),
                    ),
                    flex: 8,
                  ),
...
class SyrupCard extends StatelessWidget {
  ...
  SyrupCard({@required this.syrupText ,@required this.value , @required this.groupValue , @required this.onChanged}) ;
...
class ToppingsCard extends StatelessWidget {
  ...
  ToppingsCard({@required this.toppingName , @required this.value , @required this.onChanged,@required this.activate});
    ...
    return Container(
      ...
      child: CheckboxListTile(
        ...
        title: Text(
          toppingName,
          style: TextStyle(
            decoration: activate==true ? TextDecoration.none : TextDecoration.lineThrough,
            fontSize: 18,
            fontFamily: 'Ragazzi ExB',
            color: activate==true ? Colors.black.withOpacity(0.8) : Colors.black.withOpacity(0.22),
          ),
        ),
        value: value,
