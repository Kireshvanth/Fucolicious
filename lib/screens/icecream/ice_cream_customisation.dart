        ...
        children: [
          if (value == true)
            Container(
              ...
              child: Image(
                image: AssetImage(
                    "assests/ice_cream/CheckBox-Selected/CheckBox-Selected.png"),
              ),
            ),
          if (value == false)
            Container(
              ...
              child: Image(
                image: AssetImage(
                    "assests/ice_cream/CheckBox-Unselected/CheckBox-Unselected.png"),
              ),
            ),
          Theme(
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (borderColor == Color(0xffFFBE3D))
                    Image(
                        image: AssetImage(
                            "assests/ice_cream/Serving_Selected_Underline_Path/Serving_Selected_Underline_Path.png"))
                ],
              ),
            ),
          ],
